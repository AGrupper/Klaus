# Milestone v2.0: Consciousness & Autonomy — ARCHIVE

**Status:** ✅ SHIPPED 2026-05-23
**Phases:** 14-18 (5 phases)
**Total Plans:** 24 (15 pre-Phase-18 + 9 Phase 18)
**Requirements:** 41/41 complete

This archive preserves the milestone-v2.0 roadmap as shipped. The active
`.planning/ROADMAP.md` is overwritten on milestone close with a compact
milestone summary; the per-phase detail lives here.
